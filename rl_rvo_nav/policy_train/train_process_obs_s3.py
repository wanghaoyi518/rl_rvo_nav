...
par_train.add_argument('--load_name', default='r4_mode7_stage2_4_0/r4_mode7_stage2_4_0_check_point_400.pt')  # 从stage2模型开始
...
args = parser.parse_args([
    '--train_epoch', '500', 
    '--robot_number', '8', 
    '--load_name', 'r4_mode7_stage2_6_0/r4_mode7_stage2_6_0_check_point_400.pt', 
    '--con_train', 
    '--use_gpu'
])
...
print("🎯 Mode 7 Stage 3 课程学习训练")
print("=" * 60)
print(f"📁 加载Stage 2模型: {load_fname}")
